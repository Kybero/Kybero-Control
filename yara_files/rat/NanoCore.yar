rule RAT_NanoCore_A_con {
   meta:
      threat_name = "RAT/NanoCore.A!con"
...
rule RAT_NanoCore_B_con {
   meta:
      threat_name = "RAT/NanoCore.B!con"
...
rule RAT_NanoCore_C_con {
   meta:
      threat_name = "RAT/NanoCore.C!con"
...
rule RAT_NanoCore_D_con {
   meta:
      threat_name = "RAT/NanoCore.D!con"
      description = "Detetcs a certain Nanocore RAT sample"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
      score = 75
...
rule RAT_NanoCore_E_con {
   meta:
      threat_name = "RAT/NanoCore.E!con"
...
rule RAT_NanoCore_F_con {
   meta:
      threat_name = "RAT/NanoCore.F!con"
      description = "Detects Nanocore RAT"
      license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
      author = "Florian Roth (Nextron Systems)"
      reference = "Internal Research - T2T"
