rule Trojan_HermeticWiper_A_con {
   meta:
      threat_name = "Trojan/HermeticWiper.A!con"
...
rule Trojan_HermeticWiper_B_con {
   meta:
      threat_name = "Trojan/HermeticWiper.B!con"
...
rule Trojan_HermeticWiper_C_con {
   meta:
      threat_name = "Trojan/HermeticWiper.C!con"
