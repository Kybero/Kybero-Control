rule Trojan_WhisperGate_A_con {
   meta:
      threat_name = "Trojan/WhisperGate.A!con"
...
rule Trojan_WhisperGate_B_con {
   meta:
      threat_name = "Trojan/WhisperGate.B!con"
      description = "Detects unknown wiper malware"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://www.microsoft.com/security/blog/2022/01/15/destructive-malware-targeting-ukrainian-organizations/"
      date = "2022-01-16"
...
rule Trojan_WhisperGate_C_con {
   meta:
      threat_name = "Trojan/WhisperGate.C!con"
...
rule Trojan_WhisperGate_D_con {
   meta:
      threat_name = "Trojan/WhisperGate.D!con"
