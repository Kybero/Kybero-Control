...
rule Trojan_Generic_W {
    meta:
        threat_name = "Trojan/Generic.W"
        author = "ditekSHen"
...
rule Trojan_Generic_X {
    meta:
	threat_name = "Trojan/Generic.X"
        author = "ditekSHen"
...
rule Trojan_Generic_Y {
    meta:
	threat_name = "Trojan/Generic.Y"
        author = "Elastic Security"
...
rule Trojan_Generic_Z {
   meta:
      threat_name = "Trojan/Generic.Z"
