rule Trojan_Qakbot_A_con {
    meta:
        threat_name = "Trojan/Qakbot.A!con"
...
rule Trojan_Qakbot_B_con {
    meta:
        threat_name = "Trojan/Qakbot.B!con"
        author = "Elastic Security"
...
rule Trojan_Qakbot_C_con {
    meta:
        threat_name = "Trojan/Qakbot.C!con"
        author = "Elastic Security"
...
rule Trojan_Qakbot_D_con {
    meta:
        threat_name = "Trojan/Qakbot.D!con"
        author = "Elastic Security"
...
rule Trojan_Qakbot_E_con {
    meta:
        threat_name = "Trojan/Qakbot.E!con"
        author = "Elastic Security"
